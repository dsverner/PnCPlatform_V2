# Rehearsal 2026-09-14 — `PnCPlatform_V2_QA`

Started 2026-09-14T20:47:07; loaders: legacy_import.

## Outcome

- First pass wrote **262,625** target rows across 1 run(s); **262,625** provenance rows.
...
## dbRelayManagement_Legacy — run `CDF7C150-75FB-472E-B67C-6D2777321346`

Actor `3CA3535A-E72C-465F-922D-E16ACD4326A9`; 390,890 procedure calls in 4497.0s.
