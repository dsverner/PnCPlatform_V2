# Reconciliation — dbRelayManagement_Legacy → PnCPlatform_V2_DEV — 2026-09-22

Run `6490CCE9-8DD1-4FCF-85F7-EDF355FB10EC` · 47372 procedure calls · 561 s · limit none
...
| legacy database track row → work.RequestTrack (#227) | 11,840 |
| legacy documentation track row → work.RequestTrack (#227) | 11,840 |
...
| work request revised in place under a changed rule (card H) | 1 |
...
| `process.ProcedureInstance` | 0 | 11,840 |
| `record.Finding` | 0 | 19 |
| `scheme.Scheme` | 0 | 1,769 |
| `scheme.SchemeMember` | 0 | 6,839 |
| `work.AlternateKey` | 0 | 11,880 |
| `work.RequestTrack` | 23,680 | 0 |
| `work.WorkRequest` | 1 | 11,839 |
...
| `NoTrackRows` | 20,163 | A0001 A0001/3: no legacy track row anywhere; landed complete with both tracks NA (#164); A0002 A0002/2144042: no legacy track row anywhere; landed complete with both tracks NA (#164); P0003 P0003/7268134: no legacy track row anywhere; landed complete with both tracks NA (#164); A0004 A0004/6793753:  |
...
| `TrackRowMissing` | 2 | M7043 M7043/2307330: no legacy documentation track row; InProgress; M7043 M7043/2307330: no legacy database track row; InProgress |
| `TrackStatusUnknown` | 26 | P1398 P1398/1170: documentation track status None; InProgress (set it by hand); P1398 P1398/1170: database track status None; InProgress (set it by hand); P1398 P1398/9607020: documentation track status None; InProgress (set it by hand); P1398 P1398/9607020: database track status None; InProgress (s |
| `TrackUnderOtherCr` | 6,796 | P0002 P0002/2141435: doc track found under CR 2144042 (SETTINGS and the track disagree) — card H; P0002 P0002/2141435: db track found under CR 2144042 (SETTINGS and the track disagree) — card H; P0004 P0004/3196082: doc track found under CR 3380710 (SETTINGS and the track disagree) — card H; P0004 P |
