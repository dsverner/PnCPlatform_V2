# Rehearsal 2026-09-14 — `PnCPlatform_V2_DEV`

Started 2026-09-14T18:23:26; loaders: legacy_import.

## Outcome

- First pass wrote **151,336** target rows across 1 run(s); **151,336** provenance rows.
...
## dbRelayManagement_Legacy — run `5BF931B5-721B-4FE6-9EF9-69D7448979A6`

Actor `C9E8B1A8-E13E-4B12-88AB-293B002F5EFE`; 156,499 procedure calls in 6043.6s.
