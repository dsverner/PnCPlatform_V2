# Reconciliation — dbRelayManagement_Legacy → PnCPlatform_V2_DEV — 2026-09-15

Run `311DA460-CD6F-407B-A636-0EE8E2ED1D46` · 181477 procedure calls · 2060 s · limit none
...
| `process.BlockInstance` | 100,815 | 0 |
| `process.InstanceVersionSet` | 13,442 | 0 |
| `process.ProcedureInstance` | 6,721 | 5,119 |
| `process.StepInstance` | 40,326 | 0 |
| `process.WorkflowInstance` | 6,721 | 0 |
| `process.WorkflowTransition` | 6,721 | 0 |
| `record.Finding` | 0 | 19 |
