...
| 2026-09-25 | #238: the CIP impact rating Medium recorded on the line L2103 itself (typed on DEV 2026-09-16, MigrationRunId NULL) withdrawn - empty value through asset.RecordClassification, as the system actor, audited | the owner, 2026-09-25: "withdraw the L2103 CIP rating" - the rating is the building's (#171/#195); not imported, so nothing for the cutover to replay. asset.RecordClassification now refuses a CIP rating on a primary asset (50237) | no |
