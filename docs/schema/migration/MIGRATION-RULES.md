...
| Rule | Seed |
|---|---|
| #194 the legacy classification columns are dropped (untrusted); the CT/PT ratio columns stay as characteristics | `Seed_config_CharacteristicSchema_SettingsRecord.sql` |
