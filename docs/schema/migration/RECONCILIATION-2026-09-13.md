...
Run `88B9FC0E-B60C-4872-9128-D093056DE82E` · 4845 procedure calls · 146 s · limit none
...
| M row → a SETTINGS_CHANGE run landed at COMPLETION with its two tracks (#56) | 352 |
...
| `process.WorkflowTransition` | 4,829 | 0 |
| `record.Finding` | 0 | 19 |
...
| `LandingNotRepaired` | 5 | M3378 M3378/7205759: landed earlier under other track states; a landed run is not re-shaped; M3379 M3379/7205816: landed earlier under other track states; a landed run is not re-shaped; M3381 M3381/7205930: landed earlier under other track states; a landed run is not re-shaped; M3382 M3382/7205987:  |
...
| `SapWorkOrderDuplicate` | 7 | 8375553 CR 8375553: SapWorkOrder '000000' already belongs to another request; no key written; 911 CR 911: SapWorkOrder '3000040109' already belongs to another request; no key written; 8233397 CR 8233397: SapWorkOrder '3000019301' already belongs to another request; no key written; 3440 CR 3440: SapW |
