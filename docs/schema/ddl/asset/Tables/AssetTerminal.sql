-- #170 (2026-09-16): where a primary asset terminates — as many terminals as the asset has, numbered 1, 2, … (the owner: a
-- capacitor or reactor has one, a transformer two, a transmission line could theoretically have n; a three-terminal line is
-- usually two line numbers). Each terminal is a station; the system itself has none. This replaces the placement a
