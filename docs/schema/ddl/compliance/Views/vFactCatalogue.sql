...
FROM (VALUES
    ...
    (N'device.functions',        N'Fixed', N'device.functions',        NULL, N'scheme',     N'vPositionFunction',     N'AnsiCode',         N'Set',         NULL, N'Device',             N'ValidTime', NULL, NULL, N'["load_responsive"]'),   -- #197: the elements in service at the device's position, as codes; [load_responsive='true'] the ones PRC-023-6 Attachment A includes
    (N'device.functions.note',   N'Fixed', N'device.functions.note',   NULL, N'scheme',     N'vPositionFunction',     N'LoadResponsiveBasis', N'Text',     NULL, N'Device',             N'ValidTime', NULL, NULL, NULL),   -- #197: each element with its ruling and the clause - the reason a person reads
