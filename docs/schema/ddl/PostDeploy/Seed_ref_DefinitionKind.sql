...
USING (VALUES
    ...
    (N'Program.Workflow',                         N'Program',              N'Workflow (PROCEDURE-ENGINE §2; document per workflow.schema.json from W3)', 1),
    (N'Program.Procedure',                        N'Program',              N'Procedure (PROCEDURE-ENGINE §3; document per procedure.schema.json, W3)', 1),
