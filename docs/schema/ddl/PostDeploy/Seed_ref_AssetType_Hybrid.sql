...
EXEC [ref].[AssetType_Upsert] @AssetTypeCode = N'CCPD', @Name = N'Coupling capacitor potential device', @Description = N'A coupling capacitor potential device (predecessor CCPD, INTERFACE)', @AssetClassCode = N'Hybrid', @IsDevice = 0, @ActorId = @actor;
